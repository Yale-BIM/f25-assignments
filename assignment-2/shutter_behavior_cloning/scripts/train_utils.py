...
# TODO - replace the MODEL_URL with the URL to your torch model in Google Drive.
...
# Then, you should have a copy of your model named my_torch_model in your local disk.
MODEL_URL = 'https://drive.google.com/uc?id=<file_id>'
NORM_PARAMS_URL = 'https://drive.google.com/uc?id=<file_id>'
...
def download_model_files(output_path=".", quiet=False, model_name="torch_model", norm_params_name="norm_params"):
    """
    Helper function to download a trained PyTorch model from Google Drive
