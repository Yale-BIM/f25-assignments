...
3. **You can run TensorBoard on Google Colab.** You can follow
[this instruction](https://colab.research.google.com/github/tensorflow/tensorboard/blob/master/docs/tensorboard_in_notebooks.ipynb) to run TensorBoard on your
